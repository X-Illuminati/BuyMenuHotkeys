...
if (nil ~= BindingsUI_GetBindingsData) then
    ...
    if (not binding_data_patched) then
        local additionalDefaultBindings =
        {
            ...
            {kBMHKFadeKey,         "4"},
            {kBMHKOnosKey,         "5"},
            {kBMHKCrushKey,        "NumPad9"},
            {kBMHKCarapaceKey,     "NumPad6"},
            {kBMHKRegenerationKey, "NumPad3"},
            //{kBMHKPhantomKey,      "NumPad8"},
            {kBMHKFocusKey,        "NumPad8"},
            {kBMHKVampirismKey,    "NumPad5"},
            {kBMHKAuraKey,         "NumPad2"},
            {kBMHKAdrenalineKey,   "NumPad7"},
            {kBMHKCelerityKey,     "NumPad4"},
            {kBMHKSilenceKey,      "NumPad1"},
            {kBMHKWelderKey,       "1"},
            {kBMHKMinesKey,        "2"},
            {kBMHKShotgunKey,      "3"},
            {kBMHKClusterKey,      "4"},
        ...
        local additionalControlBindings =
        {
            ...
            kBMHKCrushKey,        "input", "Select Crush",              "NumPad9",
            kBMHKCarapaceKey,     "input", "Select Carapace",           "NumPad6",
            kBMHKRegenerationKey, "input", "Select Regeneration",       "NumPad3",
            //kBMHKPhantomKey,      "input", "Select Phantom",            "NumPad8",
            kBMHKFocusKey,        "input", "Select Focus",              "NumPad8",
            kBMHKVampirismKey,    "input", "Select Vampirism",          "NumPad5",
            kBMHKAuraKey,         "input", "Select Aura",               "NumPad2",
            kBMHKAdrenalineKey,   "input", "Select Adrenaline",         "NumPad7",
            kBMHKCelerityKey,     "input", "Select Celerity",           "NumPad4",
            kBMHKSilenceKey,      "input", "Select Silence",            "NumPad1",
...
// - Add keybinds for silence, vampirism, crush, and focus
